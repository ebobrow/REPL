...
Proof.
  intros b c Hb.
  split; intros H; apply while_true_nonterm in H.
  - inversion H.
  - assumption.
  - inversion H.
  - constructor.
...
Theorem assign_aequiv : forall (X : string) (a : aexp),
  ...
  cequiv <{ skip }> <{ X := a }>.
Proof.
  intros X a Heq. split; intros.
  - inversion H. subst.
    rewrite <- t_update_same with (x := X). apply E_Asgn.
    unfold aequiv in Heq. rewrite <- Heq. reflexivity.
  - inversion H. subst.
    unfold aequiv in Heq. simpl in Heq. rewrite <- Heq.
...
Theorem CSeq_congruence : forall c1 c1' c2 c2',
  ...
  cequiv <{ c1;c2 }> <{ c1';c2' }>.
Proof.
  intros c1 c1' c2 c2' Heq1 Heq2. split; intros H.
  - inversion H. subst. apply E_Seq with st'0.
    + unfold cequiv in Heq1. apply Heq1 in H2. apply H2.
    + unfold cequiv in Heq2. apply Heq2 in H5. apply H5.
  - inversion H. subst. apply E_Seq with st'0.
    + unfold cequiv in Heq1. apply Heq1 in H2. apply H2.
    + unfold cequiv in Heq2. apply Heq2 in H5. apply H5.
Qed.
...
Theorem CIf_congruence : forall b b' c1 c1' c2 c2',
  ...
  cequiv <{ if b then c1 else c2 end }>
         <{ if b' then c1' else c2' end }>.
Proof.
  intros b b' c1 c1' c2 c2' Hb Hc1 Hc2. split; intros H.
  - inversion H; subst.
    + apply E_IfTrue.
      * unfold bequiv in Hb. rewrite Hb in H5. assumption.
      * unfold cequiv in Hc1. apply Hc1 in H6. assumption.
    + apply E_IfFalse.
      * unfold bequiv in Hb. rewrite Hb in H5. assumption.
      * unfold cequiv in Hc2. apply Hc2 in H6. assumption.
  - inversion H; subst.
    + apply E_IfTrue.
      * unfold bequiv in Hb. rewrite <- Hb in H5. assumption.
      * unfold cequiv in Hc1. apply Hc1 in H6. assumption.
...
Fixpoint optimize_0plus_aexp (a : aexp) : aexp :=
  match a with
    | AId x => AId x
    | ANum n => ANum n
    | APlus 0 n => optimize_0plus_aexp n
    | APlus a b => APlus (optimize_0plus_aexp a) (optimize_0plus_aexp b)
    | AMinus a b => AMinus (optimize_0plus_aexp a) (optimize_0plus_aexp b)
    | AMult a b => AMult (optimize_0plus_aexp a) (optimize_0plus_aexp b)
  end.
...
Proof.
  unfold atrans_sound. induction a; try constructor.
  - simpl. destruct a1.
    + simpl. destruct n.
      * apply IHa2.
      * unfold aequiv in IHa2. unfold aequiv. intros st. simpl.
        rewrite <- IHa2. reflexivity.
    + simpl. unfold aequiv. intros st. unfold aequiv in IHa2.
      simpl. rewrite <- IHa2. reflexivity.
    + unfold aequiv. intros st. unfold aequiv in IHa1. simpl.
      rewrite <- IHa1. simpl. unfold aequiv in IHa2. rewrite IHa2. reflexivity.
    + unfold aequiv. intros st. unfold aequiv in IHa2. simpl.
      rewrite <- IHa2. unfold aequiv in IHa1. Admitted.
...
Proof.
  intros. induction a; try (simpl; inversion H; apply IHa1 in H2; apply IHa2 in H3;
    rewrite H2; rewrite H3; reflexivity).
  - reflexivity.
  - inversion H. simpl. unfold t_update. Admitted.
